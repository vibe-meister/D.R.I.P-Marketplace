      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <div className="glass rounded-xl p-6 text-center">
            ...
            <div className="text-2xl font-bold gradient-text mb-2">{stats?.totalRevenue} ETH</div>
          ...
          <div className="glass rounded-xl p-6 text-center">
            ...
            <div className="text-2xl font-bold gradient-text mb-2">{stats?.platformFees} ETH</div>
          ...
          <div className="glass rounded-xl p-6 text-center">
            ...
            <div className="text-2xl font-bold gradient-text mb-2">{stats?.creatorPayouts} ETH</div>
              ...
              <tbody>
                {transactions.map((tx, index) => (
                  ...
                  >
                    ...
                    <td className="py-4 px-2">
                      <span className="text-teal-400 font-semibold">{tx.amount} ETH</span>
                    </td>
                    <td className="py-4 px-2">
                      <span className="text-yellow-400 font-semibold">{tx.platformFee} ETH</span>
                    </td>
                    <td className="py-4 px-2">
                      <div className="flex items-center space-x-2">
              ...
              <div className="space-y-4">
                <div className="bg-white/5 rounded-lg p-4">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-yellow-400 font-semibold">2.5 ETH</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-white/60">Platform Fees Earned</span>
                    <span className="text-teal-400 font-semibold">0.125 ETH</span>
                  </div>
                </div>
